...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  TNode<SeqOneByteString> AllocateSeqOneByteString(TNode<Uint32T> p_length);
  ...
  TNode<Smi> LoadStackFrameInfoPromiseCombinatorIndex(TNode<StackFrameInfo> p_o);
  void StoreStackFrameInfoPromiseCombinatorIndex(TNode<StackFrameInfo> p_o, TNode<Smi> p_v);
  ...
  TNode<Object> LoadStackFrameInfoScriptName(TNode<StackFrameInfo> p_o);
  void StoreStackFrameInfoScriptName(TNode<StackFrameInfo> p_o, TNode<Object> p_v);
  TNode<Object> LoadStackFrameInfoScriptNameOrSourceUrl(TNode<StackFrameInfo> p_o);
  void StoreStackFrameInfoScriptNameOrSourceUrl(TNode<StackFrameInfo> p_o, TNode<Object> p_v);
  ...
  TNode<Smi> LoadWasmExportedFunctionDataSignatureType(TNode<WasmExportedFunctionData> p_o);
  void StoreWasmExportedFunctionDataSignatureType(TNode<WasmExportedFunctionData> p_o, TNode<Smi> p_v);
  ...
  TNode<Map> LoadWasmTypeInfoParent(TNode<WasmTypeInfo> p_o);
  void StoreWasmTypeInfoParent(TNode<WasmTypeInfo> p_o, TNode<Map> p_v);
