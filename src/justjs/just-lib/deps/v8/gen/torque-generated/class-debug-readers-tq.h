...
class TqStackFrameInfo : public TqStruct {
 public:
  ...
  uintptr_t GetPromiseCombinatorIndexAddress() const;
  Value<uintptr_t> GetPromiseCombinatorIndexValue(d::MemoryAccessor accessor ) const;
...
class TqWasmExportedFunctionData : public TqStruct {
 public:
  ...
  uintptr_t GetSignatureTypeAddress() const;
  Value<uintptr_t> GetSignatureTypeValue(d::MemoryAccessor accessor ) const;
};
