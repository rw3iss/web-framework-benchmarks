...
TorqueStructReference_Null_OR_JSProxy_0 ContextSlot_ProxyRevokeFunctionContext_ProxyRevokeFunctionContext_Null_OR_JSProxy_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block6.is_used()) {
    ...
    std::tie(tmp13, tmp14) = ReferenceCast_Null_OR_JSProxy_Object_0(state_, TorqueStructReference_Object_0{TNode<HeapObject>{tmp11}, TNode<IntPtrT>{tmp12}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block9);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block9);
  return TorqueStructReference_Null_OR_JSProxy_0{TNode<HeapObject>{tmp13}, TNode<IntPtrT>{tmp14}, TorqueStructUnsafe_0{}};
}
