...
TNode<PromiseCapability> InnerNewPromiseCapability_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_constructor, TNode<Oddball> p_debugEvent) {
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp27, &block7, std::vector<Node*>{}, &block8, std::vector<Node*>{});
  }
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.Branch(tmp10, &block1, std::vector<Node*>{}, &block2, std::vector<Node*>{});
  }
  ...
  if (block2.is_used()) {
    ...
    tmp20 = CodeStubAssembler(state_).CallBuiltin(Builtins::kRejectPromise, tmp0, tmp4, parameter2, tmp19);
...
USE(parameter1);
  ...
  if (block2.is_used()) {
    ...
    tmp15 = True_0(state_);
    CodeStubAssembler(state_).StoreReference<Oddball>(CodeStubAssembler::Reference{tmp13, tmp14}, tmp15);
    tmp16 = CodeStubAssembler(state_).CallBuiltin(Builtins::kResolvePromise, tmp0, tmp4, parameter2);
...
USE(parameter1);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp9 = True_0(state_);
    tmp10 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kNewPromiseCapability, parameter0, tmp0, tmp9));
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.Branch(tmp8, &block3, std::vector<Node*>{}, &block4, std::vector<Node*>{});
  }
...
TNode<Object> GetPromiseResolve_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<JSReceiver> p_constructor) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Branch(tmp2, &block2, std::vector<Node*>{}, &block3, std::vector<Node*>{tmp0});
  }
...
TorqueStructReference_JSPromise_0 ContextSlot_PromiseResolvingFunctionContext_PromiseResolvingFunctionContext_JSPromise_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block6.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp9});
    std::tie(tmp11, tmp12) = NewReference_Object_0(state_, TNode<HeapObject>{p_context}, TNode<IntPtrT>{tmp10}).Flatten();
    std::tie(tmp13, tmp14) = ReferenceCast_JSPromise_Object_0(state_, TorqueStructReference_Object_0{TNode<HeapObject>{tmp11}, TNode<IntPtrT>{tmp12}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block9);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block9);
  return TorqueStructReference_JSPromise_0{TNode<HeapObject>{tmp13}, TNode<IntPtrT>{tmp14}, TorqueStructUnsafe_0{}};
}
...
TorqueStructReference_Boolean_0 ContextSlot_PromiseResolvingFunctionContext_PromiseResolvingFunctionContext_Boolean_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block6.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp9});
    std::tie(tmp11, tmp12) = NewReference_Object_0(state_, TNode<HeapObject>{p_context}, TNode<IntPtrT>{tmp10}).Flatten();
    std::tie(tmp13, tmp14) = ReferenceCast_Boolean_Object_0(state_, TorqueStructReference_Object_0{TNode<HeapObject>{tmp11}, TNode<IntPtrT>{tmp12}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block9);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block9);
  return TorqueStructReference_Boolean_0{TNode<HeapObject>{tmp13}, TNode<IntPtrT>{tmp14}, TorqueStructUnsafe_0{}};
}
