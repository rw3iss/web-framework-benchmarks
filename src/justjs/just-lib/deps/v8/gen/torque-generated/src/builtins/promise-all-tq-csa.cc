...
void InitContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_Smi_constexpr_int31_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index, int31_t p_value) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{p_context, tmp3});
  ...
  if (block17.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{p_index}, TNode<IntPtrT>{tmp9});
    tmp11 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp10});
    std::tie(tmp12, tmp13) = NewReference_Object_0(state_, TNode<HeapObject>{p_context}, TNode<IntPtrT>{tmp11}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp12, tmp13}, tmp0);
    ca_.Goto(&block20);
  }
...
TorqueStructReference_Map_0 ContextSlot_NativeContext_NativeContext_Map_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block6.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp9});
    std::tie(tmp11, tmp12) = NewReference_Object_0(state_, TNode<HeapObject>{p_context}, TNode<IntPtrT>{tmp10}).Flatten();
    std::tie(tmp13, tmp14) = ReferenceCast_Map_Object_0(state_, TorqueStructReference_Object_0{TNode<HeapObject>{tmp11}, TNode<IntPtrT>{tmp12}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block9);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block9);
  return TorqueStructReference_Map_0{TNode<HeapObject>{tmp13}, TNode<IntPtrT>{tmp14}, TorqueStructUnsafe_0{}};
}
...
TNode<Object> PerformPromiseAll_PromiseAllResolveElementFunctor_PromiseAllRejectElementFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TorqueStructIteratorRecord p_iter, TNode<JSReceiver> p_constructor, TNode<PromiseCapability> p_capability, TNode<Object> p_promiseResolveFunction, TorqueStructPromiseAllResolveElementFunctor_0 p_createResolveElementFunctor, TorqueStructPromiseAllRejectElementFunctor_0 p_createRejectElementFunctor, compiler::CodeAssemblerLabel* label_Reject, compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0) {
  ...
  if (block12.is_used()) {
    ...
    ca_.Branch(tmp18, &block10, std::vector<Node*>{phi_bb12_11}, &block11, std::vector<Node*>{phi_bb12_11});
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Branch(tmp31, &block22, std::vector<Node*>{phi_bb18_11}, &block23, std::vector<Node*>{phi_bb18_11});
  }
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp57, &block36, std::vector<Node*>{phi_bb23_11}, &block37, std::vector<Node*>{phi_bb23_11});
  }
  ...
  if (block37.is_used()) {
    ...
    tmp63 = PromiseBuiltinsAssembler(state_).IsPromiseHookEnabledOrDebugIsActiveOrHasAsyncEventDelegate();
    }
  ...
  if (block38.is_used()) {
    ...
    ca_.Branch(phi_bb38_17, &block41, std::vector<Node*>{phi_bb38_11}, &block42, std::vector<Node*>{phi_bb38_11});
  }
  ...
  if (block43.is_used()) {
    ...
    ca_.Branch(phi_bb43_17, &block46, std::vector<Node*>{phi_bb43_11}, &block47, std::vector<Node*>{phi_bb43_11});
  }
  ...
  if (block48.is_used()) {
    ...
    ca_.Branch(phi_bb48_17, &block51, std::vector<Node*>{phi_bb48_11}, &block52, std::vector<Node*>{phi_bb48_11});
  }
  ...
  if (block53.is_used()) {
    ...
    ca_.Branch(phi_bb53_17, &block33, std::vector<Node*>{phi_bb53_11}, &block34, std::vector<Node*>{phi_bb53_11});
  }
  ...
  if (block33.is_used()) {
    ...
    ca_.Branch(tmp104, &block66, std::vector<Node*>{phi_bb33_11}, &block67, std::vector<Node*>{phi_bb33_11});
  }
  ...
  if (block68.is_used()) {
    ...
    ca_.Branch(phi_bb68_20, &block63, std::vector<Node*>{phi_bb68_11}, &block64, std::vector<Node*>{phi_bb68_11});
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp136, &block76, std::vector<Node*>{phi_bb5_11}, &block77, std::vector<Node*>{phi_bb5_11});
  }
  ...
  if (block77.is_used()) {
    ca_.Bind(&block77, &phi_bb77_11);
    {
      ...
      pos_stack.push_back({"src/builtins/promise-all.tq", 279});
  ...
  if (block76.is_used()) {
    ...
    ca_.Branch(tmp138, &block78, std::vector<Node*>{phi_bb76_11}, &block79, std::vector<Node*>{phi_bb76_11});
  }
  ...
  if (block78.is_used()) {
    ...
    ca_.Branch(tmp147, &block81, std::vector<Node*>{phi_bb78_11}, &block82, std::vector<Node*>{phi_bb78_11});
  }
...
TNode<Object> PerformPromiseAll_PromiseAllSettledResolveElementFunctor_PromiseAllSettledRejectElementFunctor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TorqueStructIteratorRecord p_iter, TNode<JSReceiver> p_constructor, TNode<PromiseCapability> p_capability, TNode<Object> p_promiseResolveFunction, TorqueStructPromiseAllSettledResolveElementFunctor_0 p_createResolveElementFunctor, TorqueStructPromiseAllSettledRejectElementFunctor_0 p_createRejectElementFunctor, compiler::CodeAssemblerLabel* label_Reject, compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0) {
  ...
  if (block23.is_used()) {
    ...
    ca_.Branch(tmp56, &block36, std::vector<Node*>{phi_bb23_11}, &block37, std::vector<Node*>{phi_bb23_11});
  }
  ...
  if (block37.is_used()) {
    ...
    tmp62 = PromiseBuiltinsAssembler(state_).IsPromiseHookEnabledOrDebugIsActiveOrHasAsyncEventDelegate();
    }
  ...
  if (block33.is_used()) {
    ...
    ca_.Branch(tmp103, &block66, std::vector<Node*>{phi_bb33_11}, &block67, std::vector<Node*>{phi_bb33_11});
  }
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp135, &block76, std::vector<Node*>{phi_bb5_11}, &block77, std::vector<Node*>{phi_bb5_11});
  }
  ...
  if (block76.is_used()) {
    ...
    ca_.Branch(tmp137, &block78, std::vector<Node*>{phi_bb76_11}, &block79, std::vector<Node*>{phi_bb76_11});
  }
  ...
  if (block78.is_used()) {
    ...
    ca_.Branch(tmp146, &block81, std::vector<Node*>{phi_bb78_11}, &block82, std::vector<Node*>{phi_bb78_11});
  }
