...
USE(parameter2);
  ...
  if (block2.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).LoadJSReceiverIdentityHash(TNode<Object>{parameter2}, &label6);
    ca_.Goto(&block13);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block14);
  ...
  if (block13.is_used()) {
    ...
    ca_.Branch(tmp22, &block19, std::vector<Node*>{}, &block20, std::vector<Node*>{tmp12});
  }
  ...
  if (block20.is_used()) {
    ...
    tmp32 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{phi_bb20_8, tmp31});
    tmp33 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp32});
    tmp34 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp8});
    ...
    ca_.Branch(tmp36, &block25, std::vector<Node*>{}, &block26, std::vector<Node*>{});
  }
  ...
  if (block25.is_used()) {
    ...
    tmp38 = CodeStubAssembler(state_).IntPtrMul(TNode<IntPtrT>{tmp8}, TNode<IntPtrT>{tmp37});
    tmp39 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp29}, TNode<IntPtrT>{tmp38});
    std::tie(tmp40, tmp41) = NewReference_Object_0(state_, TNode<HeapObject>{phi_bb20_8}, TNode<IntPtrT>{tmp39}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp40, tmp41}, parameter3);
    tmp42 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
    tmp43 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp16}, TNode<Smi>{tmp42});
    tmp44 = kPromiseAnyRejectElementRemainingSlot_0(state_);
    std::tie(tmp45, tmp46) = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context>{tmp2}, TNode<IntPtrT>{tmp44}).Flatten();
    CodeStubAssembler(state_).StoreReference<Smi>(CodeStubAssembler::Reference{tmp45, tmp46}, tmp43);
    tmp47 = FromConstexpr_Smi_constexpr_int31_0(state_, 0);
    tmp48 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{tmp43}, TNode<Smi>{tmp47});
    ca_.Branch(tmp48, &block28, std::vector<Node*>{}, &block29, std::vector<Node*>{});
  }
  ...
  if (block28.is_used()) {
    ca_.Bind(&block28);
    tmp49 = ConstructAggregateError_0(state_, TNode<Context>{tmp2}, TNode<FixedArray>{phi_bb20_8});
    tmp50 = kPromiseAnyRejectElementCapabilitySlot_0(state_);
    ...
    tmp58 = CodeStubAssembler(state_).Call(TNode<Context>{tmp2}, TNode<Object>{tmp56}, TNode<Object>{tmp57}, TNode<Object>{tmp49});
    ca_.Goto(&block29);
  }
...
TNode<Object> PerformPromiseAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TorqueStructIteratorRecord p_iteratorRecord, TNode<JSReceiver> p_constructor, TNode<PromiseCapability> p_resultCapability, TNode<Object> p_promiseResolveFunction, compiler::CodeAssemblerLabel* label_Reject, compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0) {
  ...
  if (block10.is_used()) {
    ...
    ca_.Branch(tmp8, &block8, std::vector<Node*>{phi_bb10_8}, &block9, std::vector<Node*>{phi_bb10_8});
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp21, &block20, std::vector<Node*>{phi_bb16_8}, &block21, std::vector<Node*>{phi_bb16_8});
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Branch(tmp72, &block41, std::vector<Node*>{}, &block42, std::vector<Node*>{});
  }
  ...
  if (block43.is_used()) {
    ...
    ca_.Branch(phi_bb43_17, &block38, std::vector<Node*>{}, &block39, std::vector<Node*>{});
  }
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp101, &block49, std::vector<Node*>{phi_bb3_8}, &block50, std::vector<Node*>{phi_bb3_8});
  }
