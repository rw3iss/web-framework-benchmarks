...
std::vector<std::unique_ptr<ObjectProperty>> TqContext::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("elements", "v8::internal::TaggedValue", "v8::internal::Object", GetElementsAddress(), i::PlatformSmiTagging::SmiToInt(indexed_field_count.value), 4, std::move(elements_struct_field_list), GetArrayKind(indexed_field_count.validity)));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqName::GetProperties(d::MemoryAccessor accessor) const {
  ...
  hash_field_struct_field_list.push_back(std::make_unique<StructProperty>("hash_not_computed", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
  hash_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_not_integer_index_mask", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
  hash_field_struct_field_list.push_back(std::make_unique<StructProperty>("array_index_value", CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 24, 2));
  hash_field_struct_field_list.push_back(std::make_unique<StructProperty>("array_index_length", CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 6, 26));
...
std::vector<std::unique_ptr<ObjectProperty>> TqFixedArray::GetProperties(d::MemoryAccessor accessor) const {
  ...
  Value<uintptr_t> indexed_field_count = GetLengthValue(accessor);
  result.push_back(std::make_unique<ObjectProperty>("objects", "v8::internal::TaggedValue", "v8::internal::Object", GetObjectsAddress(), i::PlatformSmiTagging::SmiToInt(indexed_field_count.value), 4, std::move(objects_struct_field_list), GetArrayKind(indexed_field_count.validity)));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWeakCell::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("unregister_token", "v8::internal::TaggedValue", "v8::internal::Object", GetUnregisterTokenAddress(), 1, 4, std::move(unregister_token_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqSloppyArgumentsElements::GetProperties(d::MemoryAccessor accessor) const {
  ...
  Value<uintptr_t> indexed_field_count = GetLengthValue(accessor);
  result.push_back(std::make_unique<ObjectProperty>("mapped_entries", "v8::internal::TaggedValue", "v8::internal::Object", GetMappedEntriesAddress(), i::PlatformSmiTagging::SmiToInt(indexed_field_count.value), 4, std::move(mapped_entries_struct_field_list), GetArrayKind(indexed_field_count.validity)));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmValue::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("value_type", "v8::internal::TaggedValue", "v8::internal::Object", GetValueTypeAddress(), 1, 4, std::move(value_type_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bytes_or_ref_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bytes_or_ref", "v8::internal::TaggedValue", "v8::internal::Object", GetBytesOrRefAddress(), 1, 4, std::move(bytes_or_ref_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqFeedbackVector::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("optimized_code_weak_or_smi", "v8::internal::TaggedValue", "v8::internal::Object", GetOptimizedCodeWeakOrSmiAddress(), 1, 4, std::move(optimized_code_weak_or_smi_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> closure_feedback_cell_array_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("closure_feedback_cell_array", "v8::internal::TaggedValue", "v8::internal::FixedArray", GetClosureFeedbackCellArrayAddress(), 1, 4, std::move(closure_feedback_cell_array_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> length_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("length", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetLengthAddress(), 1, 4, std::move(length_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSRegExpResult::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("cached_indices_or_regexp", "v8::internal::TaggedValue", "v8::internal::JSObject", GetCachedIndicesOrRegexpAddress(), 1, 4, std::move(cached_indices_or_regexp_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqScript::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("eval_from_shared_or_wrapped_arguments", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetEvalFromSharedOrWrappedArgumentsAddress(), 1, 4, std::move(eval_from_shared_or_wrapped_arguments_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqSharedFunctionInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  flags2_struct_field_list.push_back(std::make_unique<StructProperty>("may_have_cached_code", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
...
std::vector<std::unique_ptr<ObjectProperty>> TqSourceTextModule::GetProperties(d::MemoryAccessor accessor) const {
  ...
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("async_evaluating", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
  result.push_back(std::make_unique<ObjectProperty>("flags", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
uintptr_t TqStackFrameInfo::GetPromiseCombinatorIndexAddress() const {
  return address_ - i::kHeapObjectTag + 12;
}

Value<uintptr_t> TqStackFrameInfo::GetPromiseCombinatorIndexValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetPromiseCombinatorIndexAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqStackFrameInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("line_number", "v8::internal::TaggedValue", "v8::internal::Object", GetLineNumberAddress(), 1, 4, std::move(line_number_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> column_number_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("column_number", "v8::internal::TaggedValue", "v8::internal::Object", GetColumnNumberAddress(), 1, 4, std::move(column_number_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> promise_combinator_index_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("promise_combinator_index", "v8::internal::TaggedValue", "v8::internal::Object", GetPromiseCombinatorIndexAddress(), 1, 4, std::move(promise_combinator_index_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> script_id_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("script_id", "v8::internal::TaggedValue", "v8::internal::Object", GetScriptIdAddress(), 1, 4, std::move(script_id_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> wasm_function_index_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("wasm_function_index", "v8::internal::TaggedValue", "v8::internal::Object", GetWasmFunctionIndexAddress(), 1, 4, std::move(wasm_function_index_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> script_name_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("script_name", "v8::internal::TaggedValue", "v8::internal::Object", GetScriptNameAddress(), 1, 4, std::move(script_name_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> script_name_or_source_url_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("script_name_or_source_url", "v8::internal::TaggedValue", "v8::internal::Object", GetScriptNameOrSourceUrlAddress(), 1, 4, std::move(script_name_or_source_url_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> function_name_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("function_name", "v8::internal::TaggedValue", "v8::internal::PrimitiveHeapObject", GetFunctionNameAddress(), 1, 4, std::move(function_name_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> method_name_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("method_name", "v8::internal::TaggedValue", "v8::internal::PrimitiveHeapObject", GetMethodNameAddress(), 1, 4, std::move(method_name_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> type_name_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("type_name", "v8::internal::TaggedValue", "v8::internal::PrimitiveHeapObject", GetTypeNameAddress(), 1, 4, std::move(type_name_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> eval_origin_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("eval_origin", "v8::internal::TaggedValue", "v8::internal::PrimitiveHeapObject", GetEvalOriginAddress(), 1, 4, std::move(eval_origin_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> wasm_module_name_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("wasm_module_name", "v8::internal::TaggedValue", "v8::internal::PrimitiveHeapObject", GetWasmModuleNameAddress(), 1, 4, std::move(wasm_module_name_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> wasm_instance_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("wasm_instance", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetWasmInstanceAddress(), 1, 4, std::move(wasm_instance_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> flag_struct_field_list;
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_eval", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_constructor", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_wasm", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_asm_js_wasm", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_user_java_script", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_toplevel", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_async", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_promise_all", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 8));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_promise_any", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 9));
...
std::vector<std::unique_ptr<ObjectProperty>> TqStackTraceFrame::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("frame_array", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetFrameArrayAddress(), 1, 4, std::move(frame_array_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> frame_index_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("frame_index", "v8::internal::TaggedValue", "v8::internal::Object", GetFrameIndexAddress(), 1, 4, std::move(frame_index_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> frame_info_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("frame_info", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetFrameInfoAddress(), 1, 4, std::move(frame_info_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> id_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("id", "v8::internal::TaggedValue", "v8::internal::Object", GetIdAddress(), 1, 4, std::move(id_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqFunctionTemplateRareData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("c_function", "v8::internal::TaggedValue", "v8::internal::Object", GetCFunctionAddress(), 1, 4, std::move(c_function_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> c_signature_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("c_signature", "v8::internal::TaggedValue", "v8::internal::Object", GetCSignatureAddress(), 1, 4, std::move(c_signature_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqFunctionTemplateInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("do_not_cache", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
  flag_struct_field_list.push_back(std::make_unique<StructProperty>("accept_any_receiver", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
  result.push_back(std::make_unique<ObjectProperty>("flag", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagAddress(), 1, 4, std::move(flag_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> length_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("length", "v8::internal::TaggedValue", "v8::internal::Object", GetLengthAddress(), 1, 4, std::move(length_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqObjectTemplateInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  data_struct_field_list.push_back(std::make_unique<StructProperty>("embedder_field_count", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 29, 2));
  result.push_back(std::make_unique<ObjectProperty>("data", "v8::internal::TaggedValue", "v8::internal::Object", GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
uintptr_t TqWasmExportedFunctionData::GetSignatureTypeAddress() const {
  return address_ - i::kHeapObjectTag + 32;
}

Value<uintptr_t> TqWasmExportedFunctionData::GetSignatureTypeValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetSignatureTypeAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmExportedFunctionData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("wrapper_code", "v8::internal::TaggedValue", "v8::internal::Code", GetWrapperCodeAddress(), 1, 4, std::move(wrapper_code_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> instance_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("instance", "v8::internal::TaggedValue", "v8::internal::WasmInstanceObject", GetInstanceAddress(), 1, 4, std::move(instance_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> jump_table_offset_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("jump_table_offset", "v8::internal::TaggedValue", "v8::internal::Object", GetJumpTableOffsetAddress(), 1, 4, std::move(jump_table_offset_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> function_index_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("function_index", "v8::internal::TaggedValue", "v8::internal::Object", GetFunctionIndexAddress(), 1, 4, std::move(function_index_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> c_wrapper_code_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("c_wrapper_code", "v8::internal::TaggedValue", "v8::internal::Object", GetCWrapperCodeAddress(), 1, 4, std::move(c_wrapper_code_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> wasm_call_target_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("wasm_call_target", "v8::internal::TaggedValue", "v8::internal::Object", GetWasmCallTargetAddress(), 1, 4, std::move(wasm_call_target_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> packed_args_size_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("packed_args_size", "v8::internal::TaggedValue", "v8::internal::Object", GetPackedArgsSizeAddress(), 1, 4, std::move(packed_args_size_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> signature_type_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("signature_type", "v8::internal::TaggedValue", "v8::internal::Object", GetSignatureTypeAddress(), 1, 4, std::move(signature_type_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmJSFunctionData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("serialized_return_count", "v8::internal::TaggedValue", "v8::internal::Object", GetSerializedReturnCountAddress(), 1, 4, std::move(serialized_return_count_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> serialized_parameter_count_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("serialized_parameter_count", "v8::internal::TaggedValue", "v8::internal::Object", GetSerializedParameterCountAddress(), 1, 4, std::move(serialized_parameter_count_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> serialized_signature_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("serialized_signature", "v8::internal::TaggedValue", "v8::internal::ByteArray", GetSerializedSignatureAddress(), 1, 4, std::move(serialized_signature_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmCapiFunctionData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("call_target", CheckTypeName<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("void*"), CheckTypeName<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("void*"), GetCallTargetAddress(), 1, 8, std::move(call_target_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> embedder_data_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("embedder_data", "v8::internal::TaggedValue", "v8::internal::Foreign", GetEmbedderDataAddress(), 1, 4, std::move(embedder_data_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> wrapper_code_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("wrapper_code", "v8::internal::TaggedValue", "v8::internal::Code", GetWrapperCodeAddress(), 1, 4, std::move(wrapper_code_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> serialized_signature_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("serialized_signature", "v8::internal::TaggedValue", "v8::internal::ByteArray", GetSerializedSignatureAddress(), 1, 4, std::move(serialized_signature_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmIndirectFunctionTable::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("sig_ids", CheckTypeName<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("void*"), CheckTypeName<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("void*"), GetSigIdsAddress(), 1, 8, std::move(sig_ids_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> targets_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("targets", CheckTypeName<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("void*"), CheckTypeName<void* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("void*"), GetTargetsAddress(), 1, 8, std::move(targets_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> managed_native_allocations_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("managed_native_allocations", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetManagedNativeAllocationsAddress(), 1, 4, std::move(managed_native_allocations_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> refs_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("refs", "v8::internal::TaggedValue", "v8::internal::FixedArray", GetRefsAddress(), 1, 4, std::move(refs_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmModuleObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("native_module", "v8::internal::TaggedValue", "v8::internal::Foreign", GetNativeModuleAddress(), 1, 4, std::move(native_module_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> export_wrappers_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("export_wrappers", "v8::internal::TaggedValue", "v8::internal::FixedArray", GetExportWrappersAddress(), 1, 4, std::move(export_wrappers_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> script_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("script", "v8::internal::TaggedValue", "v8::internal::Script", GetScriptAddress(), 1, 4, std::move(script_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTableObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("entries", "v8::internal::TaggedValue", "v8::internal::FixedArray", GetEntriesAddress(), 1, 4, std::move(entries_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> current_length_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("current_length", "v8::internal::TaggedValue", "v8::internal::Object", GetCurrentLengthAddress(), 1, 4, std::move(current_length_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> maximum_length_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("maximum_length", "v8::internal::TaggedValue", "v8::internal::Object", GetMaximumLengthAddress(), 1, 4, std::move(maximum_length_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> dispatch_tables_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("dispatch_tables", "v8::internal::TaggedValue", "v8::internal::FixedArray", GetDispatchTablesAddress(), 1, 4, std::move(dispatch_tables_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> raw_type_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("raw_type", "v8::internal::TaggedValue", "v8::internal::Object", GetRawTypeAddress(), 1, 4, std::move(raw_type_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmMemoryObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("array_buffer", "v8::internal::TaggedValue", "v8::internal::JSArrayBuffer", GetArrayBufferAddress(), 1, 4, std::move(array_buffer_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> maximum_pages_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("maximum_pages", "v8::internal::TaggedValue", "v8::internal::Object", GetMaximumPagesAddress(), 1, 4, std::move(maximum_pages_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> instances_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("instances", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetInstancesAddress(), 1, 4, std::move(instances_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmGlobalObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("untagged_buffer", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetUntaggedBufferAddress(), 1, 4, std::move(untagged_buffer_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> tagged_buffer_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("tagged_buffer", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetTaggedBufferAddress(), 1, 4, std::move(tagged_buffer_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> offset_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("offset", "v8::internal::TaggedValue", "v8::internal::Object", GetOffsetAddress(), 1, 4, std::move(offset_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> raw_type_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("raw_type", "v8::internal::TaggedValue", "v8::internal::Object", GetRawTypeAddress(), 1, 4, std::move(raw_type_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> is_mutable_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("is_mutable", "v8::internal::TaggedValue", "v8::internal::Object", GetIsMutableAddress(), 1, 4, std::move(is_mutable_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmExceptionObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("exception_tag", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetExceptionTagAddress(), 1, 4, std::move(exception_tag_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqAsmWasmData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("managed_native_module", "v8::internal::TaggedValue", "v8::internal::Foreign", GetManagedNativeModuleAddress(), 1, 4, std::move(managed_native_module_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> export_wrappers_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("export_wrappers", "v8::internal::TaggedValue", "v8::internal::FixedArray", GetExportWrappersAddress(), 1, 4, std::move(export_wrappers_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> uses_bitset_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("uses_bitset", "v8::internal::TaggedValue", "v8::internal::HeapNumber", GetUsesBitsetAddress(), 1, 4, std::move(uses_bitset_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
uintptr_t TqWasmTypeInfo::GetParentAddress() const {
  return address_ - i::kHeapObjectTag + 12;
}

Value<uintptr_t> TqWasmTypeInfo::GetParentValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetParentAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTypeInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  std::vector<std::unique_ptr<StructProperty>> parent_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("parent", "v8::internal::TaggedValue", "v8::internal::Map", GetParentAddress(), 1, 4, std::move(parent_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> subtypes_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("subtypes", "v8::internal::TaggedValue", "v8::internal::ArrayList", GetSubtypesAddress(), 1, 4, std::move(subtypes_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqInternalClassWithSmiElements::GetProperties(d::MemoryAccessor accessor) const {
  ...
  std::vector<std::unique_ptr<StructProperty>> entries_struct_field_list;
  Value<uintptr_t> indexed_field_count = GetLengthValue(accessor);
  result.push_back(std::make_unique<ObjectProperty>("entries", "v8::internal::TaggedValue", "v8::internal::Object", GetEntriesAddress(), i::PlatformSmiTagging::SmiToInt(indexed_field_count.value), 4, std::move(entries_struct_field_list), GetArrayKind(indexed_field_count.validity)));
  return result;
}
