...
TFC(WasmAllocateRtt, WasmAllocateRtt) \
TFC(WasmAllocateStructWithRtt, WasmAllocateStructWithRtt) \
TFC(WasmIsRttSubtype, WasmIsRttSubtype) \
...
TFC(ThrowWasmTrapFuncInvalid, ThrowWasmTrapFuncInvalid) \
TFC(ThrowWasmTrapFuncSigMismatch, ThrowWasmTrapFuncSigMismatch) \
TFC(ThrowWasmTrapDataSegmentDropped, ThrowWasmTrapDataSegmentDropped) \
...
TFC(ThrowWasmTrapBrOnExnNull, ThrowWasmTrapBrOnExnNull) \
...
#define TORQUE_FUNCTION_POINTER_TYPE_TO_BUILTIN_MAP(V) \
  ...
  V(12,GenericBuiltinTest_JSAny_0)\
